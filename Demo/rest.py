...
st.set_page_config(page_title="ReST", layout="wide", page_icon="./Icon.ico")
st.title("ReST")
...
tab_image, tab_video, tab_live_stream, tab_upload_model = st.tabs(["Image", "Video", "Live Stream", "Custom Model"])
