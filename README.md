# [MV-Soccer: Motion-Vector Augmented Instance Segmentation for Soccer Player Tracking](https://github.com/MrFahad/MV-Soccer/) <br> </a><a><img src="cvpr.png" width="300" class="right"></a>
